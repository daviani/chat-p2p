...
export class JwtService {
  ...
  auth0Client$ = (from(
    createAuth0Client({
      domain: "beertobear.eu.auth0.com",
      client_id: "fA7qxOuLbSkJ7YxAZLxVo3bbrLPwn2o7",
  ...
  handleAuthCallback() {
    ...
    const authComplete$ = this.auth0Client$.pipe(
      ...
      tap(cbRes => {
        ...
        targetRoute = cbRes.appState && cbRes.appState.target ? cbRes.appState.target : 'messenger-main';
      }),
      concatMap(() => {
